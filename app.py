...
CSV_FILES = [
    "pricebook_au_q2-202ix5.xlsx - Trellix Helix.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Email Security.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Endpoint Security.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Server Security.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Data Security.csv",
    "pricebook_au_q2-2025.xlsx - Trellix EU_DE Data Center.csv",
    "pricebook_au_q2-2025.xlsx - Trellix JP_ AU Data Centers.csv",
    "pricebook_au_q2-2025.xlsx - Trellix SG Data Center.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Network Security.csv",
    "pricebook_au_q2-2025.xlsx - Trellix IVX.csv",
    "pricebook_au_q2-2025.xlsx - Trellix SIEM.csv",
    "pricebook_au_q2-2025.xlsx - Trellix HW Accessories.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Success Services.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Legacy.csv",
    "pricebook_au_q2-2025.xlsx - Trellix Legacy (former FireEye.csv",
    "pricebook_au_q2-2025.xlsx - Skyhigh.csv",
    "pricebook_au_q2-2025.xlsx - Skyhigh DE Data Center.csv",
    "pricebook_au_q2-2025.xlsx - Skyhigh NON GA QUOTES ONLY.csv",
    "pricebook_au_q2-2025.xlsx - Skyhigh Legacy.csv",
    # Exclude general sheets like Coversheet, Index, RawData, Additions, Changes for direct search
    # "pricebook_au_q2-2025.xlsx - Coversheet.csv",
    # "pricebook_au_q2-2025.xlsx - Coversheet_Japanese.csv",
    # "pricebook_au_q2-2025.xlsx - Index.csv",
    # "pricebook_au_q2-2025.xlsx - RawData.csv",
    # "pricebook_au_q2-2025.xlsx - Additions.csv",
    # "pricebook_au_q2-2025.xlsx - MSRP_Margin_Cost_Change.csv",
    # "pricebook_au_q2-2025.xlsx - Deletions.csv",
    # "pricebook_au_q2-2025.xlsx - ALL Changes.csv",
]
